    ...
    <section class="projets" id="projets">
        <div class="container">
            ...
            <div class="row mb-4 h-100">
                <div class="col-md-4 col-12 d-flex justify-content-center bulle mb-5"><a target="_blank" href="https://nicolas-peter.fr/projets/ProjetMark/"><img class="img-fluid" src="assets/img/Mark.png" alt="Mark"></a><span class="affiche mb-4">Intégration de maquette avec Bootstrap</span></div>
                <div class="col-md-4 col-12 d-flex justify-content-center bulle mb-5"><a target="_blank" href="https://nicolas-peter.fr/projets/ProjetTablesMultiplication/"><img class="img-fluid" src="assets/img/multiplication.png" alt=""></a><span class="affiche">Tables de multiplication en PHP</span></div>
                <div class="col-md-4 col-12 d-flex justify-content-center bulle mb-5"><a target="_blank" href="https://nicolas-peter.fr/projets/ProjetItalianRestaurant/"><img class="img-fluid" src="assets/img/italian.png" alt=""></a><span class="affiche">Intégration de maquette sans Bootstrap</span></div>
